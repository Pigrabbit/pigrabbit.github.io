---
title: Deploy Deep Learning model with React Native
date: 2021-02-24
tags:
  - Object Detection
  - Deep Learning
...
> Deploying 'Helment Detection model' with React Native application
...
Accordingly, I decided to solve this problem by object detection apporach.
...
- False Negative: A person is wearing a helmet, model detects a person with a helmet
